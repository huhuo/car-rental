				...
				<div class="row-fluid">
					...
					<div class="span4 well">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="number" disabled="disabled" class="consumerinput required digits" value="${consumer.username } 
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="number" disabled="disabled" class="consumerinput required digits" id="inputCellPhone"  value="${consumer.mobileNumber }
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="number" class="consumerinput required digits" id="inputTelephone"   disabled="disabled"  value="${consumer.telephone } 
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="number" class="consumerinput required digits" id="inputBirthday"  disabled="disabled"  value="${consumer.birthday } 
						...
						<div class="control-group">
							...
							<div class="controls">
								<label class="radio inline"> <input type="radio"
									id="inputGender" name="gender" id="optionsRadios1" value="1"  readonly="readonly"
									checked> 男
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="number" class="consumerinput required digits"  disabled="disabled"  value="${consumer.permanentAddress }
